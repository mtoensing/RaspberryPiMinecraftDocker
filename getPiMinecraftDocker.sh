...
echo "###"
echo "###"
echo "### Now open Minecraft. Select Mutliplayer, Add Server, Server Address and put in this hostname:" $(hostname -I | cut -d' ' -f1)
echo "###"
echo "### It may take some to start the server for the first time. You can check with the following two commands what the status is:"
echo "newgrp docker"
